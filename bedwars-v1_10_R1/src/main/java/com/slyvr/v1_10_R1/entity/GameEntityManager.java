package com.slyvr.v1_10_R1.entity;
...
public class GameEntityManager implements com.slyvr.api.entity.GameEntityManager {
	...
	public BedBug createBedBug(Game game, Team team, GamePlayer owner, Location loc) {
		return new com.slyvr.v1_10_R1.entity.BedBug(game, team, owner, loc);
	}

	@Override
	public BedBug getBedBug(Entity entity) {
		net.minecraft.server.v1_10_R1.Entity result = ((CraftEntity) entity).getHandle();
	...
	public BodyGuard createBodyGuard(Game game, Team team, GamePlayer owner, Location loc) {
		return new com.slyvr.v1_10_R1.entity.BodyGuard(game, team, owner, loc);
	}
	...
	public Dragon createDragon(Game game, Team team, GamePlayer owner, Location loc) {
		return new com.slyvr.v1_10_R1.entity.Dragon(game, team, owner, loc);
	}
	...
	static {
		registerEntity("BedBug", 60, EntitySilverfish.class, com.slyvr.v1_10_R1.entity.BedBug.class);
		registerEntity("BodyGuard", 99, EntityIronGolem.class, com.slyvr.v1_10_R1.entity.BodyGuard.class);
		registerEntity("Dragon", 63, EntityEnderDragon.class, com.slyvr.v1_10_R1.entity.Dragon.class);
	}
