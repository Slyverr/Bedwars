...
import com.slyvr.v1_12_R1.entity.GameEntityManager;
...
public class NPCManager implements com.slyvr.api.npc.NPCManager {
	...
	public Shopkeeper createShopKeeper(Game game, Location loc) {
		return new com.slyvr.v1_12_R1.npc.Shopkeeper(game, loc);
	}

	@Override
	public Upgrader createUpgrader(Game game, Location loc) {
		return new com.slyvr.v1_12_R1.npc.Upgrader(game, loc);
	}
	...
	static {
		GameEntityManager.registerEntity("Shopkeeper", 120, EntityVillager.class, com.slyvr.v1_12_R1.npc.Shopkeeper.class);
		GameEntityManager.registerEntity("Upgrader", 120, EntityVillager.class, com.slyvr.v1_12_R1.npc.Upgrader.class);
	}
